...
class _CreateMaintenanceViewState extends State<CreateMaintenanceView> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Remplissez les informations des nouveaux frais ',
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          validator: (value) {
                            if (value == null || value.trim().isEmpty) {
                              return 'Le type de machine est requis';
                            }
                            return null;
                          },
                        ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton.icon(
                                      onPressed:
                                          viewModel.isLoading ? null : _createExpense,
  ...
  Future<void> _createExpense() async {
    ...
    final success = await _viewModel.createMaintenanceExpense(request);
    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Frais créés avec succès'),
